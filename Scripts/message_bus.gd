...
signal projectile_collision(collision_type: String, position: Vector2, target_id: int, destruction_shape: DestructionShape)
signal projectile_collided_with_player(target_id: int, damage: float)
signal projectile_collided_with_terrain(position: Vector2, destruction_shape: DestructionShape)
